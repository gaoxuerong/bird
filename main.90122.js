(function () {
    ...
    function boot () {
        ...
        var bundledScript = settings.debug ? 'src/project.dev.f4fac.js' : 'src/project.js';
        if (jsList) {
    ...
    if (window.document) {
        ...
        cocos2d.async = true;
        cocos2d.src = window._CCSettings.debug ? 'cocos2d-js.56c0c.js' : 'cocos2d-js-min.js';
